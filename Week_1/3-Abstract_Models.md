...
[Download the slides here](W1-V2-abstract-models.pptx)

:::{iframe} https://www.youtube.com/embed/GX1SIWfhGKc?end=18
:width: 100%
:align: center
:::
---
...
:::{iframe} https://www.youtube.com/embed/GX1SIWfhGKc?start=18&end=92
:width: 100%
:align: center
:::
...
:::{iframe} https://www.youtube.com/embed/GX1SIWfhGKc?start=92&end=152
:width: 100%
:align: center
:::
...
Idealised Picture of Membrane Potential vs Time (see [code](#biological-neuron-fig-label))
```
...
:::{iframe} https://www.youtube.com/embed/GX1SIWfhGKc?start=152&end=200
:width: 100%
:align: center
:::
...
Graph Detailling Behavior of Integrate and Fire Model (see [code](#integrate-and-fire-fig-label))
```
...
:::{iframe} https://www.youtube.com/embed/GX1SIWfhGKc?start=200&end=251
:width: 100%
:align: center
:::
...
Graphs Detailling Behavior of Leaky Integrate and Fire Model (see [code](#LIF-fig-label))
```
...
:::{iframe} https://www.youtube.com/embed/GX1SIWfhGKc?start=251&end=385
:width: 100%
:align: center
:::
...
LIF Spike Timing Graphs for Constant and Fluctuating Input Current (see [paper](https://doi.org/10.1126/science.7770778) and [code](#Brian-LIF-fig-label))
```
...
LIF Spike Timing Graphs for Constant and Fluctuating Input Current Without a Leak (see [paper](https://doi.org/10.1126/science.7770778) and [code](#Brian-non-LIF-fig-label))
```
...
:::{iframe} https://www.youtube.com/embed/GX1SIWfhGKc?start=385&end=454
:width: 100%
:align: center
:::
...
Improved LIF Model (see [code](#LIF-with-synapses-fig-label))
```
...
:::{iframe} https://www.youtube.com/embed/GX1SIWfhGKc?start=454&end=575
:width: 100%
:align: center
:::
...
Spike Frequency Adaptation Memory Model (see [code](#adaptive-LIF-fig-label))
```
...
:::{iframe} https://www.youtube.com/embed/GX1SIWfhGKc?start=575
:width: 100%
:align: center
:::
